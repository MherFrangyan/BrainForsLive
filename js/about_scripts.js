        ...
        staffArray.forEach((item,idx)=> {
            if (window.innerWidth > 1160){
                if (idx < 7 || idx >= 14){
                    ...
                    x++;
                    if (idx < 10) {
                        workers.innerHTML += `<div class="col-4 worker_main worker_${x}_col">
                        <div class="worker  worker_${x}">
                        <div class="worket__about">
                          <h2 class="worker__name">${item.name}</h2>
                          <p class="worker__role">${item.position}</p>
                        </div>
                       <img src="${item.img}" alt="Worker Img" class="worker__photo worker__photo${x}">
                        </div>
                      </div>`
                    } else {
                        workers.innerHTML += `<div class="col-3 worker_main worker_${x}_col">
                        <div class="worker  worker_${x} ">
                        <div class="worket__about">
                          <h2 class="worker__name">${item.name}</h2>
                          <p class="worker__role">${item.position}</p>
                ...
                if (idx < 4 || idx >= 8){
                    ...
                    z++;
                    if (idx < 8) {
                        workers.innerHTML += `<div class="col-6 worker_main worker_${z}_col">
                        <div class="worker  worker_${z}">
                        <div class="worket__about">
                          <h2 class="worker__name">${item.name}</h2>
                          <p class="worker__role">${item.position}</p>
                        </div>
                       <img src="${item.img}" alt="Worker Img" class="worker__photo worker__photo${z}">
                        </div>
                      </div>`
                    }
                }
